...
@Category({ Categories.isThrowable.class, Categories.tag2.class, Categories.tag3.class })
public class JUnitMatchersIsThrowableTest {
	...
	public void testIfIsThrowableReturnsNullOnNullInput() {
		// Act
		try {
			// If method is part of StacktracePrintingMatcher class
			// Matcher<Throwable> result = StacktracePrintingMatcher.isThrowable(null);
			// else, replace ClassName with the correct class containing isThrowable
			// function
			// Matcher<Throwable> result = ClassName.isThrowable(null);
			// Assert
			assertNull(result);
		}
