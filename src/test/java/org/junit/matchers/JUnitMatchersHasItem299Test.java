...
public class JUnitMatchersHasItem299Test {

	@Test
	public void testHasItemWhenItemExists() {
		// Arrange
		Iterable<Integer> numbers = Arrays.asList(1, 2, 3, 4, 5);
		Matcher<Integer> existsMatcher = CoreMatchers.is(3);
		// Act
		boolean result = JUnitMatchers.hasItem(existsMatcher).matches(numbers);
		// Assert
		assertTrue(result);
	}
	...
	public void testHasItemWhenItemDoesNotExist() {
		// Arrange
		Iterable<Integer> numbers = Arrays.asList(1, 2, 3, 4, 5);
		Matcher<Integer> doesNotExistMatcher = CoreMatchers.is(7);
		// Act
		boolean result = JUnitMatchers.hasItem(doesNotExistMatcher).matches(numbers);
		// Assert
		assertFalse(result);
	}
	...
	public void testHasItemWithEmptyCollection() {
		// Arrange
		Iterable<Integer> emptyNumbers = new ArrayList<>();
		Matcher<Integer> matcher = CoreMatchers.is(3);
		// Act
		boolean result = JUnitMatchers.hasItem(matcher).matches(emptyNumbers);
		// Assert
		assertFalse(result);
	}
	...
	public void testHasItemWithNullCollection() {
		// Arrange
		Iterable<Integer> nullNumbers = null;
		Matcher<Integer> matcher = CoreMatchers.is(3);
		// Act
		JUnitMatchers.hasItem(matcher).matches(nullNumbers);
