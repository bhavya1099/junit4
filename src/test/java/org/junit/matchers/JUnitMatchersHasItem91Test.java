...
public class JUnitMatchersHasItem91Test {
    @Test
    public void testHasItemWhenItemExists() {
        List<String> testList = Arrays.asList("Item1", "Item2", "Item3");
        Matcher<String> stringMatcher = is("Item2");
        assertThat(testList, hasItem(stringMatcher));
    }
    @Test
    public void testHasItemWhenItemDoesNotExist() {
        List<String> testList = Arrays.asList("Item1", "Item2", "Item3");
        Matcher<String> stringMatcher = is("Item4");
        try {
            assertThat(testList, hasItem(stringMatcher));
    ...
    public void testHasItemWithEmptyCollection() {
        ...
        Matcher<String> stringMatcher = is("Item1");
        try {
            assertThat(testList, hasItem(stringMatcher));
            fail("Expected AssertionError");
        } catch (AssertionError ignored) {}
    ...
    public static <T> Matcher<Iterable<? super T>> hasItem(Matcher<? super T> itemMatcher) {
        return CoreMatchers.hasItem(itemMatcher);
    }
}