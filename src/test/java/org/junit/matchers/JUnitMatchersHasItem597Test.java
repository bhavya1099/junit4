...
public class JUnitMatchersHasItem597Test {
    @Test
    public void testHasItemWhenItemExists() {
        // Arrange
        List<String> myList = Arrays.asList("apple", "banana", "cherry");
        Matcher<String> myMatcher = CoreMatchers.is("banana");
        // Act
        boolean hasItem = myList.stream().anyMatch(item -> myMatcher.matches(item));
        // Assert
    ...
    public void testHasItemWhenItemDoesNotExist() {
        // Arrange
        List<String> myList = Arrays.asList("apple", "banana", "cherry");
        Matcher<String> myMatcher = CoreMatchers.is("peach");
        // Act
        boolean hasItem = myList.stream().anyMatch(item -> myMatcher.matches(item));
        // Assert
