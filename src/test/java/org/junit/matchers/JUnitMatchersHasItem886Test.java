...
public void testHasItemWhenItemExists() {
  ...
  assertThat("The list does not contain the item", list, hasItem("apple"));
}
@Test
public void testHasItemWhenItemDoesNotExist() {
  List<String> list = Arrays.asList("apple", "banana", "cherry");
  assertThat("The list does not contain the item", list, CoreMatchers.not(hasItem("pear")));
}
@Test
public void testHasItemWithEmptyCollection() {
  List<String> list = Collections.emptyList();
  assertThat("The list does not contain the item", list, CoreMatchers.not(hasItem("apple")));
}
@Test(expected = NullPointerException.class)
public void testHasItemWithNullCollection() {
  List<String> list = null;
  if (list != null) {
    assertFalse("The list should be null", list.contains("apple"));
  } else {
