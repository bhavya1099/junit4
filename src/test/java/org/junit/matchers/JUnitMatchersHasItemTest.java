...
public class JUnitMatchersHasItemTest {
	...
	public void checkHasItemWithValidInputs() {
		...
		integerList.add(2);
		integerList.add(3);
		Matcher<Iterable<? super Integer>> matcher = JUnitMatchers.hasItem(2);

		assertThat(integerList, matcher);
	}
	...
	public void checkHasItemWithInvalidInputs() {
		...
		integerList.add(2);
		integerList.add(3);
		Matcher<Iterable<? super Integer>> matcher = JUnitMatchers.hasItem(5);

		assertThat(integerList, CoreMatchers.not(matcher));
	}
	...
	public void checkHasItemWithNullElement() {
		...
		integerList.add(2);
		integerList.add(3);
		Matcher<Iterable<? super Integer>> matcher = JUnitMatchers.hasItem(null);
	...
	public void checkHasItemWithEmptyCollection() {
		List<Integer> integerList = new ArrayList<>();
		Matcher<Iterable<? super Integer>> matcher = JUnitMatchers.hasItem(1);
