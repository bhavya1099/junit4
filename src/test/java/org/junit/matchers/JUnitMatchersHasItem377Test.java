...
public class JUnitMatchersHasItem377Test {
    @Test
    public void testHasItemWhenItemExists() {
        List<String> list = Arrays.asList("apple", "banana", "cherry");
        Matcher<String> matcher = CoreMatchers.is("banana");
        Matcher<Iterable<? super String>> iterableMatcher = JUnitMatchers.hasItem(matcher);
        org.junit.Assert.assertThat(list, iterableMatcher);
    }
    @Test
    public void testHasItemWhenItemDoesNotExist() {
        List<String> list = Arrays.asList("apple", "banana", "cherry");
        Matcher<String> matcher = CoreMatchers.is("pineapple");
        Matcher<Iterable<? super String>> iterableMatcher = JUnitMatchers.hasItem(matcher);
        org.junit.Assert.assertThat(list, CoreMatchers.not(iterableMatcher));
    }
    @Test
    ...
    public void testHasItemWithNullCollection() {
        ...
        Matcher<String> matcher = CoreMatchers.is("banana");
        JUnitMatchers.hasItem(matcher).matches(list);
    }
}