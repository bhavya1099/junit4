...
public class JUnitMatchersHasItems310Test {

	@Test
	public void matchCollectionElementsWithMatchers() {
		Iterable<Integer> iterable = Arrays.asList(1, 2, 3, 4, 5);
		Matcher<Iterable<Integer>> matcher = CoreMatchers.hasItems(CoreMatchers.equalTo(1), CoreMatchers.equalTo(2));
		assertThat("Collection elements do not match Matchers", iterable, matcher);
	}
	...
	public void notMatchInEmptyCollection() {
		...
		Matcher<Iterable<Integer>> matcher = CoreMatchers.hasItems(CoreMatchers.equalTo(1), CoreMatchers.equalTo(2));
		assertThat("Empty Collection should not match Matchers", iterable, CoreMatchers.not(matcher));
	}

	@Test
	public void failToMatchUsingExactMatchers() {
		Iterable<Integer> iterable = Arrays.asList(1, 2, 3, 4, 5);
		Matcher<Iterable<Integer>> matcher = CoreMatchers.hasItems(CoreMatchers.equalTo(6), CoreMatchers.equalTo(7));
		assertThat("Collection elements should not match Matchers", iterable, CoreMatchers.not(matcher));
	}
