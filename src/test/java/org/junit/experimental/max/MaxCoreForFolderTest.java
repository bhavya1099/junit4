...
@Tag("org.junit.experimental.max.forFolder")
@Tag("org.junit.experimental.max.storedLocally")
class MaxCoreForFolderTest {

	@Test
	public void testForCorrectFolder() {
		// Arrange
		String existingFolderPath = "/path/to/existing/folder"; // TODO: replace with
																// actual path
		// Act
		MaxCore maxCore = MaxCore.forFolder(existingFolderPath);
		// Assert
		Assertions.assertNotNull(maxCore, "Expected not null MaxCore object.");
	}

	@Test
	public void testForNonExistentFolder() {
		// Arrange
		String nonExistentFolderPath = "/path/to/non/existent/folder"; // TODO: replace
																		// with actual
																		// path
		// Act & Assert
		Assertions.assertThrows(IllegalArgumentException.class, () -> MaxCore.forFolder(nonExistentFolderPath),
	...
	public void testForNullFolder() {
		// Act & Assert
		Assertions.assertThrows(NullPointerException.class, () -> MaxCore.forFolder(null),
	...
	public void testForEmptyFolder() {
		// Act & Assert
		Assertions.assertThrows(IllegalArgumentException.class, () -> MaxCore.forFolder(""),
				"Expected IllegalArgumentException to be thrown.");
	}
