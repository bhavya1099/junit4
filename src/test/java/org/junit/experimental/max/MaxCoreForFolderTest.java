...
public class MaxCoreForFolderTest {
	...
	public void testForCorrectFolder() {
		String existingFolderPath = System.getProperty("user.home"); // Assuming user's
																		// home directory
																		// exists
		MaxCore maxCore = MaxCore.forFolder(existingFolderPath);
		assertNotNull(maxCore);
	}

	@Test
	public void testForNonExistentFolder() {
		String nonExistentFolderPath = "/path/does/not/exist";
		assertThrows(IllegalArgumentException.class, () -> MaxCore.forFolder(nonExistentFolderPath));
	}

	@Test
	public void testForNullFolder() {
		assertThrows(NullPointerException.class, () -> MaxCore.forFolder(null));
	}

	@Test
	public void testForEmptyFolder() {
		assertThrows(IllegalArgumentException.class, () -> MaxCore.forFolder(""));
	}
