...
public class CouldNotReadCoreExceptionTest {
	...
	public void checkExceptionPropagation() {
		...
		CouldNotReadCoreException exception = new CouldNotReadCoreException(e);
		assertEquals(e, exception.getCause());
	}

	@Test
	public void checkExceptionSerializationRestoration() throws IOException, ClassNotFoundException {
		Throwable e = new RuntimeException("Test exception");
		CouldNotReadCoreException original = new CouldNotReadCoreException(e);
		...
		CouldNotReadCoreException deser = (CouldNotReadCoreException) ois.readObject();
		assertSame(original.getCause(), deser.getCause());
	}

	@Test
	public void checkProcessingOfNullCauses() {
		CouldNotReadCoreException exception = new CouldNotReadCoreException(null);
