...
public class MaxHistoryForFolderTest {
	...
	public void testForExistingFile() {
		...
		// TODO : Ensure the existing_file is present in your filesystem and has valid
		// MaxHistory data
	...
	public void testForFileWithCorruptData() {
		...
		// TODO : Ensure the corrupted_file is present in your filesystem and has
		// unreadable or corrupt MaxHistory data
		MaxHistory result = MaxHistory.forFolder(corruptFile);
		assertFalse(corruptFile.isFile()); // File has been deleted due to being
											// unreadable
		assertTrue(result instanceof MaxHistory); // Instance of MaxHistory would have
													// been created even if file was
													// unreadable
	}
