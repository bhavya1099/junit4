...
public class MaxCoreStoredLocallyTest {
	...
	public void testStoredLocallyWithValidFile() {
		// Arrange
		File validFile = new File("validFilePath"); // TODO: replace with valid file path
		// Act
		MaxCore maxCore = MaxCore.storedLocally(validFile);
		// Assert
		Assert.assertNotNull("MaxCore object should be created successfully.", maxCore);
	}

	@Test(expected = NullPointerException.class)
	public void testStoredLocallyWithNullFile() {
		// Act
		MaxCore maxCore = MaxCore.storedLocally(null);
	}

	@Test(expected = FileNotFoundException.class)
	public void testStoredLocallyWithNonExistentFile() {
		// Arrange
		File nonExistentFile = new File("nonExistentFilePath"); // TODO: replace with non
																// existent file path
		// Act
		MaxCore.storedLocally(nonExistentFile);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testStoredLocallyWithMalformedFile() {
		// Arrange
		File malformedFile = new File("malformedFilePath"); // TODO: replace with
															// malformed file path
		// Act
		MaxCore.storedLocally(malformedFile);
	}
