...
public class MaxCoreStoredLocallyTest {
	...
	@BeforeEach
	public void setUp() {
		validFile = new File("valid-path");
		malformedFile = new File("malformed-path");
		maxCore = new MaxCore(validFile);
	}

	@Test
	public void testStoredLocallyWithValidFile() {
		MaxCore result = MaxCore.storedLocally(validFile);
	...
	public void testStoredLocallyWithNullFile() {
		assertThrows(NullPointerException.class, () -> {
			MaxCore result = MaxCore.storedLocally(null);
		});
	}

	@Test
	public void testStoredLocallyWithMalformedFile() throws IOException {
		malformedFile.createNewFile();
		assertThrows(IOException.class, () -> {
			MaxCore result = MaxCore.storedLocally(malformedFile);
		});
